...
class UpstreamUDP
{
  public:
    ...
    Decision decide(Addr blockAddr, ThreadID tid) const;
  ...
  private:
    ...
    void maybeClear(Bloom &filter, uint64_t &insertions,
                    uint64_t capacity);
    ...
    uint64_t windowNewPrefetches{0};
    uint64_t windowUnusefulPrefetches{0};
